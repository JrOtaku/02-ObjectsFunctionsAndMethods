...
def main():
    ...
    even_better_draw_circles(rg.Point(-300,-300), 10,5,"blue",3)
    even_better_draw_circles(rg.Point(0,0), 20, 15, "green", 5)
    even_better_draw_circles(rg.Point(300, 300), 20, 5, "red", 3)
    window.update()
...
def even_better_draw_circles(point,radius,num_circles,color,thickness):
    ...
    for k in range(num_circles):  # k becomes 1, 2, 3, ... 10
